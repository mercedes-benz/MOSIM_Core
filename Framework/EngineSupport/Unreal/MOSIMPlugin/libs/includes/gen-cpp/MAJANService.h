...
class MAJANServiceIf {
 public:
  ...
  virtual void CreateAgent(std::string& _return, const std::string& name, const std::string& agentTemplate, const MRDFGraph& knowledge) = 0;
...
class MAJANServiceNull : virtual public MAJANServiceIf {
 public:
  ...
  void CreateAgent(std::string& /* _return */, const std::string& /* name */, const std::string& /* agentTemplate */, const MRDFGraph& /* knowledge */) {
    return;
  }
...
typedef struct _MAJANService_CreateAgent_args__isset {
  _MAJANService_CreateAgent_args__isset() : name(false), agentTemplate(false), knowledge(false) {}
  bool name :1;
  bool agentTemplate :1;
  bool knowledge :1;
...
class MAJANService_CreateAgent_args {
 public:
  ...
  MAJANService_CreateAgent_args() : name(), agentTemplate() {
  }
  ...
  void __set_agentTemplate(const std::string& val);
  ...
  bool operator == (const MAJANService_CreateAgent_args & rhs) const
  {
    if (!(name == rhs.name))
      return false;
    if (!(agentTemplate == rhs.agentTemplate))
      return false;
...
class MAJANService_CreateAgent_pargs {
 public:
  ...
  const std::string* agentTemplate;
...
class MAJANServiceClient : virtual public MAJANServiceIf {
 ...
 public:
  ...
  void CreateAgent(std::string& _return, const std::string& name, const std::string& agentTemplate, const MRDFGraph& knowledge);
  void send_CreateAgent(const std::string& name, const std::string& agentTemplate, const MRDFGraph& knowledge);
...
class MAJANServiceMultiface : virtual public MAJANServiceIf {
 ...
 public:
  void CreateAgent(std::string& _return, const std::string& name, const std::string& agentTemplate, const MRDFGraph& knowledge) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->CreateAgent(_return, name, agentTemplate, knowledge);
    }
    ifaces_[i]->CreateAgent(_return, name, agentTemplate, knowledge);
    return;
  }
  ...
  MAJANServiceConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
 ...
 public:
  ...
  void CreateAgent(std::string& _return, const std::string& name, const std::string& agentTemplate, const MRDFGraph& knowledge);
  int32_t send_CreateAgent(const std::string& name, const std::string& agentTemplate, const MRDFGraph& knowledge);
