...
uint32_t MAJANService_CreateAgent_args::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readString(this->agentTemplate);
          this->__isset.agentTemplate = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t MAJANService_CreateAgent_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("agentTemplate", ::apache::thrift::protocol::T_STRING, 2);
  xfer += oprot->writeString(this->agentTemplate);
  xfer += oprot->writeFieldEnd();
...
void MAJANServiceClient::CreateAgent(std::string& _return, const std::string& name, const std::string& agentTemplate, const MRDFGraph& knowledge)
{
  send_CreateAgent(name, agentTemplate, knowledge);
  recv_CreateAgent(_return);
}

void MAJANServiceClient::send_CreateAgent(const std::string& name, const std::string& agentTemplate, const MRDFGraph& knowledge)
{
  int32_t cseqid = 0;
  ...
  args.name = &name;
  args.agentTemplate = &agentTemplate;
...
void MAJANServiceProcessor::process_CreateAgent(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->CreateAgent(result.success, args.name, args.agentTemplate, args.knowledge);
...
void MAJANServiceConcurrentClient::CreateAgent(std::string& _return, const std::string& name, const std::string& agentTemplate, const MRDFGraph& knowledge)
{
  int32_t seqid = send_CreateAgent(name, agentTemplate, knowledge);
  recv_CreateAgent(_return, seqid);
}

int32_t MAJANServiceConcurrentClient::send_CreateAgent(const std::string& name, const std::string& agentTemplate, const MRDFGraph& knowledge)
{
