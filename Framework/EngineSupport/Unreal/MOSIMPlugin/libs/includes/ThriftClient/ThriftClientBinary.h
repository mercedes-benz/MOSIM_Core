...
#ifndef _THRIFT_CLIENT_BINARY_H_
#define _THRIFT_CLIENT_BINARY_H_
...
namespace MMIStandard {
	...
	public:
		...
		//	Basic constructor
		ThriftClientBinary(std::string const &address, int port, bool autoOpen = true);
