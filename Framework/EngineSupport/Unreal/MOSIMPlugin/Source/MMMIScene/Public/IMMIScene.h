 ...
 */
class IMMIScene : public IModuleInterface
{
public:
     ...
     */
    static inline IMMIScene& Get()
    {
        return FModuleManager::LoadModuleChecked<IMMIScene>( "MMIScene" );
    }
    ...
    {
        return FModuleManager::Get().IsModuleLoaded( "MMIScene" );
    }
};
