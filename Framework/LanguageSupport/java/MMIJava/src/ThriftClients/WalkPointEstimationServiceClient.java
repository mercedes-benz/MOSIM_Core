...
public class WalkPointEstimationServiceClient implements AutoCloseable
{
    ...
    public WalkPointEstimationServiceClient(String address, int port) {
    ...
    public WalkPointEstimationServiceClient(String address, int port, boolean autoOPen) {
        this.address = address;
        this.port = port;
