            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.SceneObjects = new java.util.ArrayList<java.lang.String>(_list210.size);
                ...
                for (int _i212 = 0; _i212 < _list210.size; ++_i212)
                {
                  ...
                  struct.SceneObjects.add(_elem211);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.Properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map213.size);
                ...
                for (int _i216 = 0; _i216 < _map213.size; ++_i216)
                {
                  ...
                  struct.Properties.put(_key214, _val215);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.SceneObjects != null) {
        if (struct.isSetSceneObjects()) {
          oprot.writeFieldBegin(SCENE_OBJECTS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter217 : struct.SceneObjects)
            {
      ...
      if (struct.isSetSceneObjects()) {
        {
          ...
          for (java.lang.String _iter219 : struct.SceneObjects)
          {
      ...
      if (struct.isSetProperties()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter220 : struct.Properties.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.SceneObjects = new java.util.ArrayList<java.lang.String>(_list221.size);
          ...
          for (int _i223 = 0; _i223 < _list221.size; ++_i223)
          {
            ...
            struct.SceneObjects.add(_elem222);
          }
        }
        struct.setSceneObjectsIsSet(true);
      }
