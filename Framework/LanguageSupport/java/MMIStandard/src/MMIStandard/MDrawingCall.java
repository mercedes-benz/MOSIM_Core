...
public class MDrawingCall implements org.apache.thrift.TBase<MDrawingCall, MDrawingCall._Fields>, java.io.Serializable, Cloneable, Comparable<MDrawingCall> {
  ...
  private static final org.apache.thrift.protocol.TField FUNCTION_FIELD_DESC = new org.apache.thrift.protocol.TField("Function", org.apache.thrift.protocol.TType.STRING, (short)2);
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String Function; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.FUNCTION, new org.apache.thrift.meta_data.FieldMetaData("Function", org.apache.thrift.TFieldRequirementType.REQUIRED, 
  ...
  public MDrawingCall setFunction(@org.apache.thrift.annotation.Nullable java.lang.String Function) {
    this.Function = Function;
    return this;
  }
  ...
  /** Returns true if field Function is set (has been assigned a value) and false otherwise */
  ...
  public int compareTo(MDrawingCall other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetFunction()).compareTo(other.isSetFunction());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFunction()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.Function, other.Function);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (Function == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'Function' was not present! Struct: " + toString());
    }
        ...
        switch (schemeField.id) {
          case 1: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.Type = MMIStandard.MDrawingCallType.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Data = new java.util.ArrayList<java.lang.Double>(_list124.size);
                double _elem125;
                for (int _i126 = 0; _i126 < _list124.size; ++_i126)
                {
                  _elem125 = iprot.readDouble();
                  struct.Data.add(_elem125);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.Properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map127.size);
      ...
      if (struct.Data != null) {
        if (struct.isSetData()) {
          oprot.writeFieldBegin(DATA_FIELD_DESC);
          {
            ...
            for (double _iter131 : struct.Data)
            {
      ...
      if (struct.Properties != null) {
        if (struct.isSetProperties()) {
          oprot.writeFieldBegin(PROPERTIES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter132 : struct.Properties.entrySet())
            {
  ...
  private static class MDrawingCallTupleScheme extends org.apache.thrift.scheme.TupleScheme<MDrawingCall> {
      ...
      if (struct.isSetData()) {
        {
          ...
          for (double _iter133 : struct.Data)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, MDrawingCall struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list135 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
          struct.Data = new java.util.ArrayList<java.lang.Double>(_list135.size);
          double _elem136;
          for (int _i137 = 0; _i137 < _list135.size; ++_i137)
          {
            _elem136 = iprot.readDouble();
            struct.Data.add(_elem136);
          }
        }
        struct.setDataIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.Properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map138.size);
