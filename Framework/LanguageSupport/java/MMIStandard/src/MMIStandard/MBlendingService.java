...
public class MBlendingService {
  ...
  public interface Iface extends MMIServiceBase.Iface {
    ...
    public MMIStandard.MBoolResponse SetBlendingMask(java.util.Map<MMIStandard.MJointType,java.lang.Double> mask, java.lang.String avatarID) throws org.apache.thrift.TException;

    public MMIStandard.MAvatarPostureValues Blend(MMIStandard.MAvatarPostureValues startPosture, MMIStandard.MAvatarPostureValues targetPosture, double weight) throws org.apache.thrift.TException;

  }

  public interface AsyncIface extends MMIServiceBase .AsyncIface {

    public void SetBlendingMask(java.util.Map<MMIStandard.MJointType,java.lang.Double> mask, java.lang.String avatarID, org.apache.thrift.async.AsyncMethodCallback<MMIStandard.MBoolResponse> resultHandler) throws org.apache.thrift.TException;

    public void Blend(MMIStandard.MAvatarPostureValues startPosture, MMIStandard.MAvatarPostureValues targetPosture, double weight, org.apache.thrift.async.AsyncMethodCallback<MMIStandard.MAvatarPostureValues> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends MMIServiceBase.Client implements Iface {
    ...
    public void send_SetBlendingMask(java.util.Map<MMIStandard.MJointType,java.lang.Double> mask, java.lang.String avatarID) throws org.apache.thrift.TException
    {
    ...
    public MMIStandard.MBoolResponse recv_SetBlendingMask() throws org.apache.thrift.TException
    {
    ...
    public void send_Blend(MMIStandard.MAvatarPostureValues startPosture, MMIStandard.MAvatarPostureValues targetPosture, double weight) throws org.apache.thrift.TException
    {
    ...
    public MMIStandard.MAvatarPostureValues recv_Blend() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends MMIServiceBase.AsyncClient implements AsyncIface {
    ...
    public static class SetBlendingMask_call extends org.apache.thrift.async.TAsyncMethodCall<MMIStandard.MBoolResponse> {
      private java.util.Map<MMIStandard.MJointType,java.lang.Double> mask;
      private java.lang.String avatarID;
      public SetBlendingMask_call(java.util.Map<MMIStandard.MJointType,java.lang.Double> mask, java.lang.String avatarID, org.apache.thrift.async.AsyncMethodCallback<MMIStandard.MBoolResponse> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public static class Blend_call extends org.apache.thrift.async.TAsyncMethodCall<MMIStandard.MAvatarPostureValues> {
      private MMIStandard.MAvatarPostureValues startPosture;
      private MMIStandard.MAvatarPostureValues targetPosture;
      private double weight;
      public Blend_call(MMIStandard.MAvatarPostureValues startPosture, MMIStandard.MAvatarPostureValues targetPosture, double weight, org.apache.thrift.async.AsyncMethodCallback<MMIStandard.MAvatarPostureValues> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends MMIServiceBase.AsyncProcessor<I> {
    ...
    public static class SetBlendingMask<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, SetBlendingMask_args, MMIStandard.MBoolResponse> {
      public SetBlendingMask() {
        super("SetBlendingMask");
      }
      ...
      public void start(I iface, SetBlendingMask_args args, org.apache.thrift.async.AsyncMethodCallback<MMIStandard.MBoolResponse> resultHandler) throws org.apache.thrift.TException {
        iface.SetBlendingMask(args.mask, args.avatarID,resultHandler);
      }
    }

    public static class Blend<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, Blend_args, MMIStandard.MAvatarPostureValues> {
      public Blend() {
        super("Blend");
      }
      ...
      public void start(I iface, Blend_args args, org.apache.thrift.async.AsyncMethodCallback<MMIStandard.MAvatarPostureValues> resultHandler) throws org.apache.thrift.TException {
  ...
  public static class SetBlendingMask_args implements org.apache.thrift.TBase<SetBlendingMask_args, SetBlendingMask_args._Fields>, java.io.Serializable, Cloneable, Comparable<SetBlendingMask_args>   {
    ...
    public @org.apache.thrift.annotation.Nullable java.util.Map<MMIStandard.MJointType,java.lang.Double> mask; // required
    ...
    public SetBlendingMask_args(
      java.util.Map<MMIStandard.MJointType,java.lang.Double> mask,
    ...
    public SetBlendingMask_args(SetBlendingMask_args other) {
      if (other.isSetMask()) {
        java.util.Map<MMIStandard.MJointType,java.lang.Double> __this__mask = new java.util.EnumMap<MMIStandard.MJointType,java.lang.Double>(MMIStandard.MJointType.class);
        for (java.util.Map.Entry<MMIStandard.MJointType, java.lang.Double> other_element : other.mask.entrySet()) {

          MMIStandard.MJointType other_element_key = other_element.getKey();
          java.lang.Double other_element_value = other_element.getValue();

          MMIStandard.MJointType __this__mask_copy_key = other_element_key;
    ...
    public void putToMask(MMIStandard.MJointType key, double val) {
      if (this.mask == null) {
        this.mask = new java.util.EnumMap<MMIStandard.MJointType,java.lang.Double>(MMIStandard.MJointType.class);
      }
      this.mask.put(key, val);
    }

    @org.apache.thrift.annotation.Nullable
    public java.util.Map<MMIStandard.MJointType,java.lang.Double> getMask() {
      return this.mask;
    }

    public SetBlendingMask_args setMask(@org.apache.thrift.annotation.Nullable java.util.Map<MMIStandard.MJointType,java.lang.Double> mask) {
      this.mask = mask;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case MASK:
        if (value == null) {
          ...
          setMask((java.util.Map<MMIStandard.MJointType,java.lang.Double>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.mask = new java.util.EnumMap<MMIStandard.MJointType,java.lang.Double>(MMIStandard.MJointType.class);
                  @org.apache.thrift.annotation.Nullable MMIStandard.MJointType _key143;
                  double _val144;
                  for (int _i145 = 0; _i145 < _map142.size; ++_i145)
                  {
                    _key143 = MMIStandard.MJointType.findByValue(iprot.readI32());
                    _val144 = iprot.readDouble();
                    if (_key143 != null)
                    {
                      struct.mask.put(_key143, _val144);
                    }
                  }
                  iprot.readMapEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, SetBlendingMask_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.mask != null) {
          oprot.writeFieldBegin(MASK_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<MMIStandard.MJointType, java.lang.Double> _iter146 : struct.mask.entrySet())
            {
    ...
    private static class SetBlendingMask_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<SetBlendingMask_args> {
        ...
        if (struct.isSetMask()) {
          {
            ...
            for (java.util.Map.Entry<MMIStandard.MJointType, java.lang.Double> _iter147 : struct.mask.entrySet())
            {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, SetBlendingMask_args struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TMap _map148 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
            struct.mask = new java.util.EnumMap<MMIStandard.MJointType,java.lang.Double>(MMIStandard.MJointType.class);
            @org.apache.thrift.annotation.Nullable MMIStandard.MJointType _key149;
            double _val150;
            for (int _i151 = 0; _i151 < _map148.size; ++_i151)
            {
              _key149 = MMIStandard.MJointType.findByValue(iprot.readI32());
              _val150 = iprot.readDouble();
              if (_key149 != null)
              {
                struct.mask.put(_key149, _val150);
              }
            }
          }
          struct.setMaskIsSet(true);
  ...
  public static class SetBlendingMask_result implements org.apache.thrift.TBase<SetBlendingMask_result, SetBlendingMask_result._Fields>, java.io.Serializable, Cloneable, Comparable<SetBlendingMask_result>   {
    ...
    public SetBlendingMask_result setSuccess(@org.apache.thrift.annotation.Nullable MMIStandard.MBoolResponse success) {
      this.success = success;
      return this;
    }
  ...
  public static class Blend_args implements org.apache.thrift.TBase<Blend_args, Blend_args._Fields>, java.io.Serializable, Cloneable, Comparable<Blend_args>   {
    ...
    public @org.apache.thrift.annotation.Nullable MMIStandard.MAvatarPostureValues startPosture; // required
    public @org.apache.thrift.annotation.Nullable MMIStandard.MAvatarPostureValues targetPosture; // required
    ...
    public Blend_args(Blend_args other) {
      ...
      if (other.isSetStartPosture()) {
        this.startPosture = new MMIStandard.MAvatarPostureValues(other.startPosture);
      }
      if (other.isSetTargetPosture()) {
        this.targetPosture = new MMIStandard.MAvatarPostureValues(other.targetPosture);
      }
    ...
    @org.apache.thrift.annotation.Nullable
    public MMIStandard.MAvatarPostureValues getStartPosture() {
      return this.startPosture;
    }

    public Blend_args setStartPosture(@org.apache.thrift.annotation.Nullable MMIStandard.MAvatarPostureValues startPosture) {
      this.startPosture = startPosture;
      return this;
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public MMIStandard.MAvatarPostureValues getTargetPosture() {
      return this.targetPosture;
    }

    public Blend_args setTargetPosture(@org.apache.thrift.annotation.Nullable MMIStandard.MAvatarPostureValues targetPosture) {
      this.targetPosture = targetPosture;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case START_POSTURE:
        if (value == null) {
          ...
          setStartPosture((MMIStandard.MAvatarPostureValues)value);
        }
        break;
      ...
      case TARGET_POSTURE:
        if (value == null) {
          ...
          setTargetPosture((MMIStandard.MAvatarPostureValues)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, Blend_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // START_POSTURE
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.startPosture = new MMIStandard.MAvatarPostureValues();
            ...
            case 2: // TARGET_POSTURE
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.targetPosture = new MMIStandard.MAvatarPostureValues();
  ...
  public static class Blend_result implements org.apache.thrift.TBase<Blend_result, Blend_result._Fields>, java.io.Serializable, Cloneable, Comparable<Blend_result>   {
    ...
    public Blend_result setSuccess(@org.apache.thrift.annotation.Nullable MMIStandard.MAvatarPostureValues success) {
      this.success = success;
      return this;
    }
