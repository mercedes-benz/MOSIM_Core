...
public class MAvatarUpdate implements org.apache.thrift.TBase<MAvatarUpdate, MAvatarUpdate._Fields>, java.io.Serializable, Cloneable, Comparable<MAvatarUpdate> {
  ...
  public @org.apache.thrift.annotation.Nullable MAvatarPostureValues PostureValues; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> SceneObjects; // optional
  public @org.apache.thrift.annotation.Nullable MAvatarDescription Description; // optional
  ...
  public MAvatarUpdate setPostureValues(@org.apache.thrift.annotation.Nullable MAvatarPostureValues PostureValues) {
  ...
  public MAvatarUpdate setDescription(@org.apache.thrift.annotation.Nullable MAvatarDescription Description) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.SceneObjects = new java.util.ArrayList<java.lang.String>(_list228.size);
                ...
                for (int _i230 = 0; _i230 < _list228.size; ++_i230)
                {
                  ...
                  struct.SceneObjects.add(_elem229);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Properties = new java.util.ArrayList<MPropertyUpdate>(_list231.size);
                @org.apache.thrift.annotation.Nullable MPropertyUpdate _elem232;
                for (int _i233 = 0; _i233 < _list231.size; ++_i233)
                {
                  _elem232 = new MPropertyUpdate();
                  _elem232.read(iprot);
                  struct.Properties.add(_elem232);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.SceneObjects != null) {
        if (struct.isSetSceneObjects()) {
          oprot.writeFieldBegin(SCENE_OBJECTS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter234 : struct.SceneObjects)
            {
      ...
      if (struct.Properties != null) {
        if (struct.isSetProperties()) {
          oprot.writeFieldBegin(PROPERTIES_FIELD_DESC);
          {
            ...
            for (MPropertyUpdate _iter235 : struct.Properties)
            {
      ...
      if (struct.isSetSceneObjects()) {
        {
          ...
          for (java.lang.String _iter236 : struct.SceneObjects)
          {
      ...
      if (struct.isSetProperties()) {
        {
          ...
          for (MPropertyUpdate _iter237 : struct.Properties)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.SceneObjects = new java.util.ArrayList<java.lang.String>(_list238.size);
          ...
          for (int _i240 = 0; _i240 < _list238.size; ++_i240)
          {
            ...
            struct.SceneObjects.add(_elem239);
          }
        }
        struct.setSceneObjectsIsSet(true);
      }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.Properties = new java.util.ArrayList<MPropertyUpdate>(_list241.size);
          @org.apache.thrift.annotation.Nullable MPropertyUpdate _elem242;
          for (int _i243 = 0; _i243 < _list241.size; ++_i243)
          {
            _elem242 = new MPropertyUpdate();
            _elem242.read(iprot);
            struct.Properties.add(_elem242);
          }
        }
        struct.setPropertiesIsSet(true);
      }
