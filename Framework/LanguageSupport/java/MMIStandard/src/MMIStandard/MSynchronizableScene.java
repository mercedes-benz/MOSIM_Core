...
public class MSynchronizableScene {
  ...
  public interface Iface {
    ...
    public MMIStandard.MBoolResponse ApplyUpdates(MSceneUpdate sceneUpdates) throws org.apache.thrift.TException;

    public MMIStandard.MBoolResponse ApplyManipulations(java.util.List<MSceneManipulation> sceneManipulations) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void ApplyUpdates(MSceneUpdate sceneUpdates, org.apache.thrift.async.AsyncMethodCallback<MMIStandard.MBoolResponse> resultHandler) throws org.apache.thrift.TException;

    public void ApplyManipulations(java.util.List<MSceneManipulation> sceneManipulations, org.apache.thrift.async.AsyncMethodCallback<MMIStandard.MBoolResponse> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_ApplyUpdates(MSceneUpdate sceneUpdates) throws org.apache.thrift.TException
    {
    ...
    public MMIStandard.MBoolResponse recv_ApplyUpdates() throws org.apache.thrift.TException
    {
    ...
    public void send_ApplyManipulations(java.util.List<MSceneManipulation> sceneManipulations) throws org.apache.thrift.TException
    {
    ...
    public MMIStandard.MBoolResponse recv_ApplyManipulations() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class ApplyUpdates_call extends org.apache.thrift.async.TAsyncMethodCall<MMIStandard.MBoolResponse> {
      private MSceneUpdate sceneUpdates;
      public ApplyUpdates_call(MSceneUpdate sceneUpdates, org.apache.thrift.async.AsyncMethodCallback<MMIStandard.MBoolResponse> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public static class ApplyManipulations_call extends org.apache.thrift.async.TAsyncMethodCall<MMIStandard.MBoolResponse> {
      private java.util.List<MSceneManipulation> sceneManipulations;
      public ApplyManipulations_call(java.util.List<MSceneManipulation> sceneManipulations, org.apache.thrift.async.AsyncMethodCallback<MMIStandard.MBoolResponse> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class ApplyUpdates<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, ApplyUpdates_args, MMIStandard.MBoolResponse> {
      public ApplyUpdates() {
        super("ApplyUpdates");
      }
      ...
      public void start(I iface, ApplyUpdates_args args, org.apache.thrift.async.AsyncMethodCallback<MMIStandard.MBoolResponse> resultHandler) throws org.apache.thrift.TException {
        iface.ApplyUpdates(args.sceneUpdates,resultHandler);
      }
    }

    public static class ApplyManipulations<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, ApplyManipulations_args, MMIStandard.MBoolResponse> {
      public ApplyManipulations() {
        super("ApplyManipulations");
      }
      ...
      public void start(I iface, ApplyManipulations_args args, org.apache.thrift.async.AsyncMethodCallback<MMIStandard.MBoolResponse> resultHandler) throws org.apache.thrift.TException {
  ...
  public static class ApplyUpdates_args implements org.apache.thrift.TBase<ApplyUpdates_args, ApplyUpdates_args._Fields>, java.io.Serializable, Cloneable, Comparable<ApplyUpdates_args>   {
    ...
    public @org.apache.thrift.annotation.Nullable MSceneUpdate sceneUpdates; // required
    ...
    public ApplyUpdates_args(ApplyUpdates_args other) {
      if (other.isSetSceneUpdates()) {
        this.sceneUpdates = new MSceneUpdate(other.sceneUpdates);
      }
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public MSceneUpdate getSceneUpdates() {
      return this.sceneUpdates;
    }

    public ApplyUpdates_args setSceneUpdates(@org.apache.thrift.annotation.Nullable MSceneUpdate sceneUpdates) {
      this.sceneUpdates = sceneUpdates;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case SCENE_UPDATES:
        if (value == null) {
          ...
          setSceneUpdates((MSceneUpdate)value);
        }
        break;
          ...
          switch (schemeField.id) {
            case 1: // SCENE_UPDATES
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.sceneUpdates = new MSceneUpdate();
  ...
  public static class ApplyUpdates_result implements org.apache.thrift.TBase<ApplyUpdates_result, ApplyUpdates_result._Fields>, java.io.Serializable, Cloneable, Comparable<ApplyUpdates_result>   {
    ...
    public ApplyUpdates_result setSuccess(@org.apache.thrift.annotation.Nullable MMIStandard.MBoolResponse success) {
      this.success = success;
      return this;
    }
  ...
  public static class ApplyManipulations_args implements org.apache.thrift.TBase<ApplyManipulations_args, ApplyManipulations_args._Fields>, java.io.Serializable, Cloneable, Comparable<ApplyManipulations_args>   {
    ...
    public @org.apache.thrift.annotation.Nullable java.util.List<MSceneManipulation> sceneManipulations; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SCENE_MANIPULATIONS, new org.apache.thrift.meta_data.FieldMetaData("sceneManipulations", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
              new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT              , "MSceneManipulation"))));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public ApplyManipulations_args(
      java.util.List<MSceneManipulation> sceneManipulations)
    {
      this();
      this.sceneManipulations = sceneManipulations;
    }
    ...
    public ApplyManipulations_args(ApplyManipulations_args other) {
      if (other.isSetSceneManipulations()) {
        java.util.List<MSceneManipulation> __this__sceneManipulations = new java.util.ArrayList<MSceneManipulation>(other.sceneManipulations.size());
        for (MSceneManipulation other_element : other.sceneManipulations) {
          __this__sceneManipulations.add(new MSceneManipulation(other_element));
        }
    ...
    @org.apache.thrift.annotation.Nullable
    public java.util.Iterator<MSceneManipulation> getSceneManipulationsIterator() {
      return (this.sceneManipulations == null) ? null : this.sceneManipulations.iterator();
    }

    public void addToSceneManipulations(MSceneManipulation elem) {
      if (this.sceneManipulations == null) {
        this.sceneManipulations = new java.util.ArrayList<MSceneManipulation>();
      }
      this.sceneManipulations.add(elem);
    }

    @org.apache.thrift.annotation.Nullable
    public java.util.List<MSceneManipulation> getSceneManipulations() {
      return this.sceneManipulations;
    }

    public ApplyManipulations_args setSceneManipulations(@org.apache.thrift.annotation.Nullable java.util.List<MSceneManipulation> sceneManipulations) {
      this.sceneManipulations = sceneManipulations;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case SCENE_MANIPULATIONS:
        if (value == null) {
          ...
          setSceneManipulations((java.util.List<MSceneManipulation>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.sceneManipulations = new java.util.ArrayList<MSceneManipulation>(_list328.size);
                  @org.apache.thrift.annotation.Nullable MSceneManipulation _elem329;
                  for (int _i330 = 0; _i330 < _list328.size; ++_i330)
                  {
                    _elem329 = new MSceneManipulation();
                    _elem329.read(iprot);
                    struct.sceneManipulations.add(_elem329);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, ApplyManipulations_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.sceneManipulations != null) {
          oprot.writeFieldBegin(SCENE_MANIPULATIONS_FIELD_DESC);
          {
            ...
            for (MSceneManipulation _iter331 : struct.sceneManipulations)
            {
        ...
        if (struct.isSetSceneManipulations()) {
          {
            ...
            for (MSceneManipulation _iter332 : struct.sceneManipulations)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.sceneManipulations = new java.util.ArrayList<MSceneManipulation>(_list333.size);
            @org.apache.thrift.annotation.Nullable MSceneManipulation _elem334;
            for (int _i335 = 0; _i335 < _list333.size; ++_i335)
            {
              _elem334 = new MSceneManipulation();
              _elem334.read(iprot);
              struct.sceneManipulations.add(_elem334);
            }
          }
          struct.setSceneManipulationsIsSet(true);
        }
  ...
  public static class ApplyManipulations_result implements org.apache.thrift.TBase<ApplyManipulations_result, ApplyManipulations_result._Fields>, java.io.Serializable, Cloneable, Comparable<ApplyManipulations_result>   {
    ...
    public ApplyManipulations_result setSuccess(@org.apache.thrift.annotation.Nullable MMIStandard.MBoolResponse success) {
      this.success = success;
      return this;
    }
