...
public class MCollisionDetectionService {
  ...
  public interface Iface extends MMIServiceBase.Iface {
    ...
    public MMIStandard.MVector3 ComputePenetration(MMIStandard.MCollider colliderA, MMIStandard.MTransform transformA, MMIStandard.MCollider colliderB, MMIStandard.MTransform transformB) throws org.apache.thrift.TException;

    public boolean CausesCollision(MMIStandard.MCollider colliderA, MMIStandard.MTransform transformA, MMIStandard.MCollider colliderB, MMIStandard.MTransform transformB) throws org.apache.thrift.TException;

  }

  public interface AsyncIface extends MMIServiceBase .AsyncIface {

    public void ComputePenetration(MMIStandard.MCollider colliderA, MMIStandard.MTransform transformA, MMIStandard.MCollider colliderB, MMIStandard.MTransform transformB, org.apache.thrift.async.AsyncMethodCallback<MMIStandard.MVector3> resultHandler) throws org.apache.thrift.TException;

    public void CausesCollision(MMIStandard.MCollider colliderA, MMIStandard.MTransform transformA, MMIStandard.MCollider colliderB, MMIStandard.MTransform transformB, org.apache.thrift.async.AsyncMethodCallback<java.lang.Boolean> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends MMIServiceBase.Client implements Iface {
    ...
    public void send_ComputePenetration(MMIStandard.MCollider colliderA, MMIStandard.MTransform transformA, MMIStandard.MCollider colliderB, MMIStandard.MTransform transformB) throws org.apache.thrift.TException
    {
    ...
    public MMIStandard.MVector3 recv_ComputePenetration() throws org.apache.thrift.TException
    {
    ...
    public void send_CausesCollision(MMIStandard.MCollider colliderA, MMIStandard.MTransform transformA, MMIStandard.MCollider colliderB, MMIStandard.MTransform transformB) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends MMIServiceBase.AsyncClient implements AsyncIface {
    ...
    public static class ComputePenetration_call extends org.apache.thrift.async.TAsyncMethodCall<MMIStandard.MVector3> {
      private MMIStandard.MCollider colliderA;
      private MMIStandard.MTransform transformA;
      private MMIStandard.MCollider colliderB;
      private MMIStandard.MTransform transformB;
      public ComputePenetration_call(MMIStandard.MCollider colliderA, MMIStandard.MTransform transformA, MMIStandard.MCollider colliderB, MMIStandard.MTransform transformB, org.apache.thrift.async.AsyncMethodCallback<MMIStandard.MVector3> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends MMIServiceBase.AsyncProcessor<I> {
    ...
    public static class ComputePenetration<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, ComputePenetration_args, MMIStandard.MVector3> {
      public ComputePenetration() {
        super("ComputePenetration");
      }
      ...
      public void start(I iface, ComputePenetration_args args, org.apache.thrift.async.AsyncMethodCallback<MMIStandard.MVector3> resultHandler) throws org.apache.thrift.TException {
  ...
  public static class ComputePenetration_args implements org.apache.thrift.TBase<ComputePenetration_args, ComputePenetration_args._Fields>, java.io.Serializable, Cloneable, Comparable<ComputePenetration_args>   {
    ...
    public @org.apache.thrift.annotation.Nullable MMIStandard.MCollider colliderA; // required
    public @org.apache.thrift.annotation.Nullable MMIStandard.MTransform transformA; // required
    public @org.apache.thrift.annotation.Nullable MMIStandard.MCollider colliderB; // required
    public @org.apache.thrift.annotation.Nullable MMIStandard.MTransform transformB; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.COLLIDER_A, new org.apache.thrift.meta_data.FieldMetaData("colliderA", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, MMIStandard.MCollider.class)));
      tmpMap.put(_Fields.TRANSFORM_A, new org.apache.thrift.meta_data.FieldMetaData("transformA", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, MMIStandard.MTransform.class)));
    ...
    public ComputePenetration_args(ComputePenetration_args other) {
      if (other.isSetColliderA()) {
        this.colliderA = new MMIStandard.MCollider(other.colliderA);
      }
      if (other.isSetTransformA()) {
        this.transformA = new MMIStandard.MTransform(other.transformA);
      }
      if (other.isSetColliderB()) {
        this.colliderB = new MMIStandard.MCollider(other.colliderB);
      }
      if (other.isSetTransformB()) {
        this.transformB = new MMIStandard.MTransform(other.transformB);
      }
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public MMIStandard.MCollider getColliderA() {
      return this.colliderA;
    }

    public ComputePenetration_args setColliderA(@org.apache.thrift.annotation.Nullable MMIStandard.MCollider colliderA) {
      this.colliderA = colliderA;
      return this;
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public MMIStandard.MTransform getTransformA() {
      return this.transformA;
    }

    public ComputePenetration_args setTransformA(@org.apache.thrift.annotation.Nullable MMIStandard.MTransform transformA) {
      this.transformA = transformA;
      return this;
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public MMIStandard.MCollider getColliderB() {
      return this.colliderB;
    }

    public ComputePenetration_args setColliderB(@org.apache.thrift.annotation.Nullable MMIStandard.MCollider colliderB) {
      this.colliderB = colliderB;
      return this;
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public MMIStandard.MTransform getTransformB() {
      return this.transformB;
    }

    public ComputePenetration_args setTransformB(@org.apache.thrift.annotation.Nullable MMIStandard.MTransform transformB) {
      this.transformB = transformB;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case COLLIDER_A:
        if (value == null) {
          ...
          setColliderA((MMIStandard.MCollider)value);
        }
        break;
      ...
      case TRANSFORM_A:
        if (value == null) {
          ...
          setTransformA((MMIStandard.MTransform)value);
        }
        break;
      ...
      case COLLIDER_B:
        if (value == null) {
          ...
          setColliderB((MMIStandard.MCollider)value);
        }
        break;
      ...
      case TRANSFORM_B:
        if (value == null) {
          ...
          setTransformB((MMIStandard.MTransform)value);
        }
        break;
          ...
          switch (schemeField.id) {
            case 1: // COLLIDER_A
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.colliderA = new MMIStandard.MCollider();
            ...
            case 2: // TRANSFORM_A
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.transformA = new MMIStandard.MTransform();
            ...
            case 3: // COLLIDER_B
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.colliderB = new MMIStandard.MCollider();
            ...
            case 4: // TRANSFORM_B
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.transformB = new MMIStandard.MTransform();
  ...
  public static class ComputePenetration_result implements org.apache.thrift.TBase<ComputePenetration_result, ComputePenetration_result._Fields>, java.io.Serializable, Cloneable, Comparable<ComputePenetration_result>   {
    ...
    public ComputePenetration_result setSuccess(@org.apache.thrift.annotation.Nullable MMIStandard.MVector3 success) {
      this.success = success;
      return this;
    }
  ...
  public static class CausesCollision_args implements org.apache.thrift.TBase<CausesCollision_args, CausesCollision_args._Fields>, java.io.Serializable, Cloneable, Comparable<CausesCollision_args>   {
    ...
    public CausesCollision_args setColliderA(@org.apache.thrift.annotation.Nullable MMIStandard.MCollider colliderA) {
      this.colliderA = colliderA;
      return this;
    }
    ...
    public CausesCollision_args setTransformA(@org.apache.thrift.annotation.Nullable MMIStandard.MTransform transformA) {
      this.transformA = transformA;
      return this;
    }
    ...
    public CausesCollision_args setColliderB(@org.apache.thrift.annotation.Nullable MMIStandard.MCollider colliderB) {
      this.colliderB = colliderB;
      return this;
    }
    ...
    public CausesCollision_args setTransformB(@org.apache.thrift.annotation.Nullable MMIStandard.MTransform transformB) {
      this.transformB = transformB;
      return this;
    }
