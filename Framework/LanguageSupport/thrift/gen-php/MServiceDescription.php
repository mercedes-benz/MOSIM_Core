...
class MServiceDescription
{
                ...
                case 4:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i18 = 0; $_i18 < $_size14; ++$_i18) {
                            $elem19 = null;
                            $elem19 = new \MIPAddress();
                            $xfer += $elem19->read($input);
                            $this->Addresses []= $elem19;
                        }
                ...
                case 6:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i31 = 0; $_i31 < $_size27; ++$_i31) {
                            $elem32 = null;
                            $elem32 = new \MParameter();
                            $xfer += $elem32->read($input);
                            $this->Parameters []= $elem32;
                        }
                        $xfer += $input->readListEnd();
                    } else {
                        $xfer += $input->skip($ftype);
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('MServiceDescription');
        if ($this->Name !== null) {
        ...
        if ($this->Addresses !== null) {
            ...
            foreach ($this->Addresses as $iter33) {
        ...
        if ($this->Properties !== null) {
            ...
            foreach ($this->Properties as $kiter34 => $viter35) {
        ...
        if ($this->Parameters !== null) {
            ...
            foreach ($this->Parameters as $iter36) {
