...
class MCoordinateSystemMapper_TransformFromMMI_L_args
{
    ...
    {
        return 'MCoordinateSystemMapper_TransformFromMMI_L_args';
    }
                ...
                case 2:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i319 = 0; $_i319 < $_size315; ++$_i319) {
                            $elem320 = null;
                            $xfer += $input->readI32($elem320);
                            $this->coordinateSystem []= $elem320;
                        }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('MCoordinateSystemMapper_TransformFromMMI_L_args');
        ...
        if ($this->coordinateSystem !== null) {
            ...
            foreach ($this->coordinateSystem as $iter321) {
                $xfer += $output->writeI32($iter321);
            }
            $output->writeListEnd();
            $xfer += $output->writeFieldEnd();
        }
