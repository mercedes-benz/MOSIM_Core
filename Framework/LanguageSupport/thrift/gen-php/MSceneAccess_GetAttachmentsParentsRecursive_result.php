...
class MSceneAccess_GetAttachmentsParentsRecursive_result
{
    ...
    {
        return 'MSceneAccess_GetAttachmentsParentsRecursive_result';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('MSceneAccess_GetAttachmentsParentsRecursive_result');
