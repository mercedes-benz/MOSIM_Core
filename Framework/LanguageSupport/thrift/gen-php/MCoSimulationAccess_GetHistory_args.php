...
class MCoSimulationAccess_GetHistory_args
{
    ...
    {
        return 'MCoSimulationAccess_GetHistory_args';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('MCoSimulationAccess_GetHistory_args');
        if ($this->eventType !== null) {
            $xfer += $output->writeFieldBegin('eventType', TType::STRING, 1);
