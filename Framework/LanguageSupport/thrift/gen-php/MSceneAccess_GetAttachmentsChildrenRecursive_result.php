...
class MSceneAccess_GetAttachmentsChildrenRecursive_result
{
    ...
    {
        return 'MSceneAccess_GetAttachmentsChildrenRecursive_result';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('MSceneAccess_GetAttachmentsChildrenRecursive_result');
