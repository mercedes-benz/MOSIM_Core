...
class MSkeletonAccess_InitializeAnthropometry_args
{
    ...
    {
        return 'MSkeletonAccess_InitializeAnthropometry_args';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('MSkeletonAccess_InitializeAnthropometry_args');
        if ($this->description !== null) {
            if (!is_object($this->description)) {
                throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
            }
            $xfer += $output->writeFieldBegin('description', TType::STRUCT, 1);
