...
class MMIServiceBase_Dispose_args
{
    ...
    {
        return 'MMIServiceBase_Dispose_args';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('MMIServiceBase_Dispose_args');
        if ($this->properties !== null) {
            ...
            foreach ($this->properties as $kiter57 => $viter58) {
