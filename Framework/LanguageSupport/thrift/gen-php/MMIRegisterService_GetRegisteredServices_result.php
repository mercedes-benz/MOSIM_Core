...
class MMIRegisterService_GetRegisteredServices_result
{
    ...
    {
        return 'MMIRegisterService_GetRegisteredServices_result';
    }
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i114 = 0; $_i114 < $_size110; ++$_i114) {
                            $elem115 = null;
                            $elem115 = new \MServiceDescription();
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('MMIRegisterService_GetRegisteredServices_result');
