...
class MMIRegisterService_GetRegisteredAdapters_result
{
    ...
    {
        return 'MMIRegisterService_GetRegisteredAdapters_result';
    }
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i107 = 0; $_i107 < $_size103; ++$_i107) {
                            $elem108 = null;
                            $elem108 = new \MAdapterDescription();
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('MMIRegisterService_GetRegisteredAdapters_result');
