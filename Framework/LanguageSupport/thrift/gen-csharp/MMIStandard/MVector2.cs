...
namespace MMIStandard
{
  ...
  [Serializable]
  #endif
  public partial class MVector2 : TBase
  {
    ...
    public MVector2(double X, double Y) : this() {
      this.X = X;
      this.Y = Y;
    }
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("MVector2");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("MVector2(");
      __sb.Append(", X: ");
      __sb.Append(X);
      __sb.Append(", Y: ");
      __sb.Append(Y);
